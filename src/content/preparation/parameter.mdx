...
- `USE_NEAR_OFFSET`: Set to `False` if you want to use only data with distance greater than 0.5 * wavelength in each period band. It is usually set to `False` for in practice.
